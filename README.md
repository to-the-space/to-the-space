...
### Why Three JS?
Javascript API인 webGL만 이용해서 3D를 구현할수도 있었지만 Scene, 광원, 그림자, 물체 등을 이용한 3차원 세계를 구현하려면 많은양을 코드를 써야 하고 코드가 매우 복잡해지기 때문에 유지보수가 어렵다는 점에서 webGL을 사용하는 Three JS를 이용하여 3D 요소들을 보다 직관적으로 처리할수 있도록 하였습니다.
